    ...
    <>
      <div className="grid grid-cols-12 gap-5 w-[90%] m-auto">
        ...
        <div className="col-span-12 bg-gray-100 mt-6 p-5 rounded-md ">
            ...
            <Link to={'/category'}><button className='bg-green-500 hover:bg-green-700 transition-all px-12 duration-300 text-white font-normal mt-4'>Back To Categories</button></Link>
        </div>
      }
      </div>
    </>
