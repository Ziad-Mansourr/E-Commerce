...
export default function Category() {
 ...
 <div className="col-span-12 p-3 md:col-span-4 group relative lg:col-span-2 overflow-hidden bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
